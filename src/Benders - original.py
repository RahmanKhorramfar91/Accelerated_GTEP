...
class BD():
        ...
        while True:
            ...
            with concurrent.futures.ThreadPoolExecutor(max_workers=max_workers) as executor:
                ...
                for future in concurrent.futures.as_completed(futures):
                    ...
                    self.Cuts[IterCount][sp] = copy.deepcopy(duals); # record the cuts
            ...
            Gap = np.round(abs(self.UB-self.LB)*100/self.UB,1);
    ...
    def print_best_feasible_solution(self, step_RBD, start_time, Gap, nIter):
        ...
        Print_Outcomes.publish_summary(self.best_MP_DV_vals, DVo_vals, step_RBD, nIter, self.LB, self.data, self.Setting, start_time, Gap, RAM_MB);
